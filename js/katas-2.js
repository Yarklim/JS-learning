...
Сумма этих квадратов 84100равна 290 * 290.
...
function travel(r, zipcode) {
  ...
  //   const arrAddress = r.split(',');
  //   return arrAddress;
  const filterAd = r.split(',').filter((el) => el.includes(zipcode));
  if (filterAd.length === 0) return `${zipcode}:/`;
...
// console.log(travel(ad, 'OH 43071')); // ":/"
// ? ------------------------------------------------------------------------
